...
public class OrderService {
  ...
  public OrderDTO retrieveById(Integer id) throws AccountNotFoundServiceException {
    ...
    if (optional.isEmpty()) {
      throw new AccountNotFoundServiceException("The order :: " + id + " :: was not Found");
    }
  ...
  public void update(OrderDTO dto) throws AccountNotFoundServiceException, OptimisticConcurrencyServiceException {
    Optional<OrderEntity> optional = this.orderRepository.findWithLockingById(dto.getId());
    if (optional.isEmpty()) {
      throw new AccountNotFoundServiceException("The order :: " + dto.getId() + " :: was not Found");
    }
